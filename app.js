const MODS = [
  ...
  { n: 'bunnyhop', c: 'movement', d: 'auto-hop + strafe' },
  { n: 'step', c: 'movement', d: 'wchodzenie bez skoku' },
  { n: 'spider', c: 'movement', d: 'wspinaczka po ścianach' },
  { n: 'safewalk', c: 'movement', d: 'auto-shift na krawędzi' },
  { n: 'glide', c: 'movement', d: 'wolne opadanie' },
